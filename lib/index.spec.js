...
describe('request-context', function() {
	...
	describe('error handling', function() {
		...
		function crashServer(req, res, next) {
			setTimeout(function() {
				undefined.do();
			}, 0);
		}
		...
		it('should attach given global error handler to domain', function(done) {
			var app;

			reqContext.setDefaultErrorHandler(function(err, req, res) {
				res.end();
				done();
			});
