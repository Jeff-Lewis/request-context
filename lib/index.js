...
exports = module.exports = {
	...
	/**
	 * Set a default error handler that will get set to all created domains.
	 * @param {Function} handler - Function with signature (err, req, res)
	 */
...
/**
 * Set a default error handler for domains
 * @api private
 * @param {Function} handler - Function with signature (err, req, res)
 * @throws Error
 */
